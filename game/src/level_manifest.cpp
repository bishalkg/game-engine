...
const std::unordered_map<std::string, SpriteType> CHARACTER_NAME_TO_SPRITE_TYPE = {
  ...
  {"Player_Bonkfather", SpriteType::Player_Bonkfather},
...
const std::unordered_map<SpriteType, SpriteAssets> SPRITE_CONFIG = {
  ...
  },
  {
    ...
    SpriteAssets{
      .paths = SpriteAssetPaths{
        ...
        .hitTex = "data/players/Marie/Hurt.png",
        .dieTex = "data/players/Marie/Dead.png",
        .shootTex = "data/players/Marie/Fireball.png",
        .slideTex = "data/players/Marie/Run.png",
        .runShootTex = "data/players/Marie/Fireball.png",
  ...
  {
    SpriteType::Player_Bonkfather,
    SpriteAssets{
      .paths = SpriteAssetPaths{
        .idleTex = "data/players/Bonkfather/Idle.png",
        .walkTex = "data/players/Bonkfather/Run.png",
        .runTex = "data/players/Bonkfather/Run.png",
        // .attackTex = "data/players/Bonkfather/Attack_1.png",
        .attackTex = "data/players/Bonkfather/Attack_2.png",
        .hitTex = "data/players/Bonkfather/Hurt.png",
        .dieTex = "data/players/Bonkfather/Dead.png",
        ...
        .runAttackTex = "data/players/Bonkfather/Attack_2.png", // TODO
